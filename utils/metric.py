...
def mIoU(results, masks, threshold=0.5, eps=1):
    ...
    b = len(results)
    results = results.view(b, -1).numpy()
    masks = masks.view(b, -1).numpy()
...
def groupBySamples(targets):
    ...
    for item in dict_label.items():
        ...
        if v <= 5:
            ...
            group2_5_10.append(k)
        elif 10 < v <= 20:
            group3_10_20.append(k)
        elif 20 < v <= 50:
            group4_20_50.append(k)
        elif 50 < v <= 100:
            group5_50_100.append(k)
        else:
            group6_100.append(k)
    groups = [group1_5, group2_5_10, group3_10_20, \
              group4_20_50, group5_50_100, group6_100]

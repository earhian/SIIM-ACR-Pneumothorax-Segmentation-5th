...
class RoIAlign(nn.Module):
    ...
    def forward(self, featuremap, boxes, box_ind, normalized=False):
        """
        ...
        return CropAndResizeFunction(self.crop_height, self.crop_width, self.extrapolation_value)(featuremap, boxes,
                                                                                                  box_ind)
